// js/data.js — hard-copied from ../landing (single source of truth)
// Pure Aqua: no theme tokens, just content. Keep in sync with landing/src/lib/site.ts etc.
...
// From landing/src/components/project-showcase.tsx
var PROJECTS = [
  {
    id: "file-repo",
    name: "file-repo",
...
function buildResumeMarkdown() {
  ...
  SKILL_GROUPS.forEach(function(g){
    lines.push("\n### " + g.title);
    lines.push(g.items.map(function(i){ return "- " + i.name; }).join("\n"));
  });
  lines.push("");
  lines.push("---");
  lines.push("## PROJECTS");
...
// expose globally for desktop.js
window.PORTFOLIO = { SITE: SITE, ABOUT_MD: ABOUT_MD, EXP_MD: EXP_MD, SKILL_GROUPS: SKILL_GROUPS, PROJECTS: PROJECTS, HERO_META: HERO_META, buildResumeMarkdown: buildResumeMarkdown };
